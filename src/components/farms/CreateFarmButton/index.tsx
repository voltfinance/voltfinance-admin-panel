...
const CreateFarmButton = ({
    ...
    const isKeyReady =
        rewardToken && pool && plugin && nonce !== undefined && (hasSecondReward ? Boolean(bonusRewardToken) : true);

    const areRewardsReady =
        rewardBn && rewardRateBn && (hasSecondReward ? Boolean(bonusRewardBn && bonusRewardRateBn) : true);
    ...
    const showApproveReward =
        approvalStateReward === ApprovalState.NOT_APPROVED || approvalStateReward === ApprovalState.PENDING;
