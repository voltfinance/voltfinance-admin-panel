...
const FarmPage = () => {
    ...
    const { token0, token1, pool, reward, rewardRate, rewardToken, bonusReward, bonusRewardRate, bonusRewardToken, nonce, rewardRates } = useFarmData(singleFarming?.eternalFarming)
    ...
    return <PageContainer>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
            ...
            { farm && isPoolReady ? <FarmDetails id={farm} incentiveKey={incentiveKey as IncentiveKey} /> : null }
        </div>
    </PageContainer>
